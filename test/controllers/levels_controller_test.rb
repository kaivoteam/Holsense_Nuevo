...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { description: @level.description, name: @level.name } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { description: @level.description, name: @level.name } }
